...
export const QUESTIONS = {
    ...
    SleepTime: ["sticking to consistent sleep/wake times", 1],
    ...
    SleepPray: ["praying/reading religious texts", 0],
    ...
    EmoMeditate: ["meditating/practicing mindfulness", 0],
    ...
    EmoCall: ["texting/calling a loved one or friend", 0],
    EmoPray: ["praying/reading religious texts", 0],
    EmoShower: ["taking a restorative shower or bath", 0],
    EmoEat: ["eating a healthy, balanced meal", 0],
    EmoYoga: ["practicing yoga/stretching your body", 0],
    EmoWater: ["drinking plenty of water", 1],

    // Physical
    PhysPets: ["playing with your pets", 0],
    PhysSleep: ["sticking to consistent sleep/wake times", 1],
    ...
    PhysMeditate: ["meditating/practicing mindfulness", 0],
    ...
    PhysPray: ["praying/reading religious texts", 0],

    // Productivity
    ProductConsistent: ["sticking to consistent sleep/wake times", 1],
    ProductPhone: ["putting your phone away/on do not disturb", 0],
    ...
    ProductMeditate: ["meditating/practicing mindfulness", 0],
    ...
    SocialCall: ["texting/calling a loved one or friend", 0],
    ...
    SocialSleep: ["sticking to consistent sleep/wake times", 1],
    ...
    SocialWorries: ["telling someone your worries/expressing your feelings", 0],
    SocialMeditate: ["meditating/practicing mindfulness", 0],
